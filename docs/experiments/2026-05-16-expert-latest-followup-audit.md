...
The latest recommendation asks RADIO-GS/CTF-GS to move from a strong prototype
...
| Use conservative claim framing: teacher-compatible compact 3D scene memory, not broad universal 3D understanding | `docs/paper_draft_current.md`, `paper/radio_gs_draft.tex`, `docs/PROJECT_MAINLINE.md` | Done for current draft | Continue enforcing this wording when adding new abstract/introduction edits. |
