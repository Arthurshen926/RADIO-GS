...
RGB may be processed by frozen official SAM.  Box and signed-point hypotheses
are decoded independently and combined after mask decoding using positive
inclusion and negative exclusion.  We do not treat a joint box--point prompt as
additive evidence: that control fails the frozen NVOS promotion gate.  These
three interfaces share the same Universal Field v1 but respect the distinct
statistical type of text, categorical, and registered-prompt queries.
