...
10-scene v67 teacher-balanced direct point-query protocol and are historical
diagnostics rather than the current main ScanNet table. The original rows use `gaussian_index` queries,
...
|---|---:|---:|---:|---|
| v67 baseline | 0.3538 / 0.6076 | 0.3573 / 0.6203 | 0.4293 / 0.7051 | Historical diagnostic |
| scene-mean calibration, alpha=0.5 | 0.3575 / 0.6101 | 0.3604 / 0.6227 | 0.4353 / 0.7074 | Positive label-free ablation |
| contextual kNN + scene-mean alpha=0.5 | 0.3637 / 0.6033 | 0.3708 / 0.6224 | 0.4512 / 0.7079 | Historical contextual support row |
...
Recommended paper use: keep this file as historical diagnostic context only.
The paper-facing ScanNet row is the VALA8 DINO-CV contextual kNN k16/cand80
alpha=0.45 result in
`scannet_pointcloud_radio_gs_vala8_dino_cv_contextual_knn16_cand80_scene_mean_a045_results`.
Keep alpha=0.75, aliases/stronger calibration, and label-informed diagnostics
as appendix or negative/mixed evidence.
...
- `output/scannet_pointcloud_eval/vala8_dino_cv_knn12_cand48_scene_mean_a045_queryonly_20260524/scannet_pointcloud_radio_gs_results.json`
- `output/scannet_pointcloud_eval/vala8_dino_cv_knn16_cand80_scene_mean_a045_queryonly_20260524/scannet_pointcloud_radio_gs_results.json`
