...
This table supports the paper appendix diagnostics for the ScanNet DINO-CV
...
Conclusion: the contextual-kNN diagnostic is useful as cross-domain
direct-query support, but category-macro reporting remains important because
