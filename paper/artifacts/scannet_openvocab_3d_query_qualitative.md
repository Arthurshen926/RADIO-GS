...
Binary query point-cloud visualization for the VALA-aligned-style direct point-query protocol.
The baseline is `VALA`; GaussFM panels use saved ScanNet direct point-query predictions.

Figure: `paper/figures/scannet_openvocab_3d_query_qualitative.png`

| Scene | Query | VALA IoU | GaussFM IoU | GaussFM source |
| --- | --- | ---: | ---: | --- |
