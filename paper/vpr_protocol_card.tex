\begin{table}[t]
  ...
  \begin{tabular}{ll}
    ...
    Registration views & Posed RGB/render views selected from all COLMAP poses; main row uses 96 evenly spaced views \\
    ...
    Selection & Fixed mean+2.5std score-distribution selector; fixed-ratio sweep is diagnostic only \\
