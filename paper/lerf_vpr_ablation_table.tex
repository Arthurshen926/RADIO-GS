\begin{table}[t]
  \centering
  \caption{VPR controls for LERF-OVS direct 3D object selection. Except for the explicitly marked earlier raw-center row, rows use the same fixed top-2\% primitive selector. ``Reg.'' is the mean fraction of Gaussians receiving registered rendered-view features; unregistered primitives use the direct Gaussian-center fallback unless disabled by the ablation.}
