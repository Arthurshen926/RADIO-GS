...
on the VALA eight-scene subset. Baselines are published source-paper values,
whereas \method{} is our locally auditable direct point-query result. The
evaluation domains are not yet unified, so external rows are reported context
rather than a strict same-protocol ranking; results are in percent.}
