...
\title{Supplementary Material for ``\method{}: Compact Foundation-Feature Fields for Open-Vocabulary 3D Gaussian Scene Understanding''}
...
point querying, and frame-wise foundation-feature comparisons. The tables below provide
...
peak-connected-component readout are label-free and use the heatmap argmax only to
...
supervision and analysis bridge, while the main compact direct readout in the
paper uses Gaussian-center primitive scores with fixed Support-Calibrated
Primitive Readout and does not read a multiview-registration feature cache at
inference.
...
control rather than the core compact direct readout.
...
control. It is included as an analysis readout because Multiview Primitive
Registration transfers registered multiview support to primitives, whereas the main compact direct readout uses the deployed
...
variant illustrates a boundary readout after compact primitive selection and is
