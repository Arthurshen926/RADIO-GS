...
\caption{\method{} framework. A compact multi-head hybrid Gaussian
teacher-feature field stores per-Gaussian codes and spatial context, decodes
them into teacher-space features, predicts quality/visibility, and supports
three readouts: rendered dense feature maps for
...
SAM/DINO-adaptor diagnostics are kept as appendix artifacts rather than
