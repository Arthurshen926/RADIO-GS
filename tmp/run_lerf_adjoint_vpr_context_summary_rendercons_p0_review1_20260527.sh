...
SCENE="${2:-figurines}"
MAX_FRAMES="${3:-16}"
VARIANT="${4:-adjoint_vpr_context_summary_rendercons_p0_ft20_mf${MAX_FRAMES}_20260527}"
...
echo "[lerf-adjoint-vpr-context-summary-rendercons-p0] gpu=${GPU} scene=${SCENE} cfg=${cfg}"
...
echo "[lerf-adjoint-vpr-context-summary-rendercons-p0-eval] gpu=${GPU} scene=${SCENE}"
CUDA_VISIBLE_DEVICES="${GPU}" bash radio_gs/scripts/run_repo_python.sh \
