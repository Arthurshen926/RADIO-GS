...
GPU="${1:-2}"
SCENE="${2:-figurines}"
VARIANT="${3:-raster_vpr_summary_rendercons_p0_ft20_20260527}"
...
echo "[lerf-raster-vpr-summary-rendercons-p0] gpu=${GPU} scene=${SCENE} cfg=${cfg}"
...
echo "[lerf-raster-vpr-summary-rendercons-p0-eval] gpu=${GPU} scene=${SCENE}"
CUDA_VISIBLE_DEVICES="${GPU}" bash radio_gs/scripts/run_repo_python.sh \
