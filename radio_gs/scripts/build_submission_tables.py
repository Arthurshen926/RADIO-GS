...
def build_benchmark_sheet(records: list[MethodRecord]) -> str:
    ...
    lines.append("3. Keep ScanNet paper-facing results restricted to the VALA-aligned ScanNet-8 scene set; archive legacy v67/10-scene numbers as internal diagnostics only.")
    return "\n".join(lines) + "\n"
