...
PFIR_MATERIALIZATION_REPORT="${PFIR_MATERIALIZATION_REPORT:-/mnt/pool/sqy/3d_understanding/segmentation_benchmarks/ScanNet-PFIR-Small/field_only_test_v1/materialization_report.json}"
