...
from radio_gs.scripts import materialize_lerf_valid_domain_knn_candidate as candidate
...
def test_candidate_contract_is_fixed_and_metric_closed() -> None:
    assert candidate.KNN_K == 10
    assert candidate.LOGIT_SCALE == 10.0
